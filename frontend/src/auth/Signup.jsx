...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-customPink">
      ...
      <h2 className="text
      -2xl font-semibold text-black mb-5">Sign Up</h2>
      <form 
      ...
      <div className="mt-5 text-center border-t-2 border-customPink w-96 pt-4">
        <p className="text-black py-2">Already have an account?</p>
        <Link to="/login" className="mt-2 text-black font-semibold border border-customPink px-4 py-2 rounded-lg hover:bg-black hover:text-white transition">
          Login
        </Link>
      </div>
    </div>
